 ...
 $("#preview").click(function(e) { 
  ...
  $("#send").click(function(e) { 
			e.preventDefault();
             var sub = $('#subject').val();
			 var body = $('#mail_body').val();
			 var email = $('textarea[name="email_ids"]').val();
			$(".send").colorbox({iframe:true, width:"50%", height:"20%", href: 'directsend.php?subject='+sub+'&mail_body='+body+'&email_ids='+email});	
  });
});
</script>
<div id="wrapper">
<h1 style="font-size: 2.00em;">Schedule a New Cron MAIL - Step 2 of 2</b></h1>
<form class="mailform" name="mailform" method="post" enctype="multipart/form-data">
<textarea id="email_ids" name="email_ids" style="display:none;"><?php echo $_POST['email_ids'];?></textarea>
<table width="100%">
<tr>
...
<tr>
 ...
 <br>
  ...
  <input id="send" name="send" class="send button scrolly" type="submit" value="Send Mail" href="directsend.php"/>
 </td>
</tr>
</table>
</form>
